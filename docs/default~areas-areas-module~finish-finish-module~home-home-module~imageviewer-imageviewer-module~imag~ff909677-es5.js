...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~areas-areas-module~finish-finish-module~home-home-module~imageviewer-imageviewer-module~imag~ff909677"], {
  /***/
  ...
  function srcAppDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _assets_JSON_DATA__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../assets/JSON_DATA */
    "./src/assets/JSON_DATA.ts");
    /* harmony import */
    ...
    var DataService = /*#__PURE__*/function () {
      function DataService(router, toastController, http) {
        ...
        this.sent = false;
        this.mytime = 0;
        this.finishedArea = false;
        this.alldata = _assets_JSON_DATA__WEBPACK_IMPORTED_MODULE_3__["jsondata"];
        this.allmessages = _assets_JSON_DATA__WEBPACK_IMPORTED_MODULE_3__["messages_en"];
        this.allvariables = _assets_JSON_DATA__WEBPACK_IMPORTED_MODULE_3__["variables"];
        this.lang = 'en';
        this.myeggs = [];
      }
      ...
      _createClass(DataService, [{
        key: "calcRemaining",
        value: function calcRemaining(areanum) {
          var _this = this;

          var areacodes = [];
          this.alldata[areanum].pictures.forEach(function (picture) {
            picture.rectangles.forEach(function (rectangle) {
          ...
          if (this.verbose) console.log(areacodes); //match counter

          var counter = 0; //console.log("my eggs: ");
          //console.log(this.myeggs);

          var remaining = areacodes.filter(function (item) {
            return _this.myeggs.indexOf(item) < 0;
        ...
        key: "checkDone",
        value: function checkDone(areanum) {
          var _this2 = this;

          var rem = 0;
          var tot = 0;

          var _this$calcRemaining = this.calcRemaining(areanum);

          var _this$calcRemaining2 = _slicedToArray(_this$calcRemaining, 2);

          rem = _this$calcRemaining2[0];
          tot = _this$calcRemaining2[1];

          if (rem == 0) {
            this.finishedArea = true;
            this.presentToast(this.allmessages.areas_checkdone);
            setTimeout(function () {
              _this2.router.navigate(['/areas']);
            }, 2000);
          }
        }
      }, {
        ...
        value: function checkFinish() {
          ...
          for (var i = 0; i < this.alldata.length; i++) {
            var _this$calcRemaining3 = this.calcRemaining(i);

            var _this$calcRemaining4 = _slicedToArray(_this$calcRemaining3, 2);

            rem = _this$calcRemaining4[0];
            tot = _this$calcRemaining4[1];
        ...
        key: "iHaveIt",
        value: function iHaveIt(eggcode) {
        ...
        value: function presentToastBottom(message) {
        ...
        key: "requestPostJQnodered",
        value: function requestPostJQnodered(myurl, mydata) {
          var _this3 = this;
          ...
          return new Promise(function (resolve, reject) {
            jquery__WEBPACK_IMPORTED_MODULE_6__["ajax"]({
              ...
              processData: false,
              headers: {
                "token": _this3.allvariables.db_token
              },
              timeout: 10000,
              dataType: "text",
        ...
        key: "requestPostJQForm",
        value: function requestPostJQForm(myurl, mydata) {
          console.log("JQ AJAX REQUEST ");
          return new Promise(function (resolve, reject) {
        ...
        value: function switchLang(lang) {
          switch (lang) {
            ...
            default:
              this.allmessages = _assets_JSON_DATA__WEBPACK_IMPORTED_MODULE_3__["messages_fr"];
              this.lang = 'fr';
              break;
          }
        }
    ...
    DataService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])], DataService);
    /***/
  },
  ...
  /*! exports provided: jsondata, variables, messages_fr, messages_en */

  /***/
  function srcAssetsJSON_DATATs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "jsondata", function () {
      return jsondata;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "variables", function () {
      return variables;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "messages_fr", function () {
      return messages_fr;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "messages_en", function () {
      return messages_en;
    });
    /* harmony import */
    ...
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! tslib */
    "./node_modules/tslib/tslib.es6.js"); //Type can be
...
//# sourceMappingURL=default~areas-areas-module~finish-finish-module~home-home-module~imageviewer-imageviewer-module~imag~ff909677-es5.js.map